...
data:
  ...
  bundledCode: "#line 1 \"test/generated/tree/HeavyLightDecomposition/do_use_segment_tree.test.cpp\"\
    ...
    \        lz[k] = id();\n    }\n};\n\n}  // namespace atcoder\n\n#line 216 \"test/generated/tree/HeavyLightDecomposition/do_use_segment_tree.test.cpp\"\
    \n#include <limits>\n#include <type_traits>\n#line 219 \"test/generated/tree/HeavyLightDecomposition/do_use_segment_tree.test.cpp\"\
    ...
    \ != p) hld(g, v, u, time);\n            }\n            leave[u] = time;\n   \
    \     }\n};\n} // namespace suisen\nstruct S {\n    int len;\n    long long pref,\
    \ max, suff, sum;\n    S(int len, long long pref, long long max, long long suff,\
    \ long long sum) : len(len), pref(pref), max(max), suff(suff), sum(sum) {}\n};\n\
