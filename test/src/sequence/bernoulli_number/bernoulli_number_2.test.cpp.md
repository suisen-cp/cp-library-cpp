...
data:
  ...
  bundledCode: "#line 1 \"test/src/sequence/bernoulli_number/bernoulli_number_2.test.cpp\"\
    ...
    \     return a;\n    }\n} // namespace suisen\n\n\n#line 10 \"test/src/sequence/bernoulli_number/bernoulli_number_2.test.cpp\"\
    \n\nusing mint = atcoder::modint998244353;\n\nint main() {\n    int n;\n    std::cin\
    \ >> n;\n    auto f = suisen::bernoulli_number<suisen::FormalPowerSeries<mint>>(n);\n\
    \    for (int i = 0; i <= n; ++i) {\n        std::cout << f[i].val() << \" \\\
    n\"[i == n];\n    }\n    return 0;\n}\n"
...
layout: document
redirect_from:
- /verify/test/src/sequence/bernoulli_number/bernoulli_number_2.test.cpp
- /verify/test/src/sequence/bernoulli_number/bernoulli_number_2.test.cpp.html
