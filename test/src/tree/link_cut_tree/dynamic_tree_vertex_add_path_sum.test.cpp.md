...
data:
  ...
  bundledCode: "#line 1 \"test/src/tree/link_cut_tree/dynamic_tree_vertex_add_path_sum.test.cpp\"\
    ...
    \ 6 \"test/src/tree/link_cut_tree/dynamic_tree_vertex_add_path_sum.test.cpp\"\n\
    \nlong long op(long long x, long long y) {\n    return x + y;\n}\nlong long e()\
    \ {\n    return 0;\n}\nlong long toggle(long long x) {\n    return x;\n}\n\nint\
    \ main() {\n    std::ios::sync_with_stdio(false);\n    std::cin.tie(nullptr);\n\
    \n    int n, q;\n    std::cin >> n >> q;\n\n    std::vector<long long> a(n);\n\
    \    for (auto& e : a) std::cin >> e;\n\n    using DynamicTree = suisen::LinkCutTree<long\
  ...
  verifiedWith: []
documentation_of: test/src/tree/link_cut_tree/dynamic_tree_vertex_add_path_sum.test.cpp
layout: document
redirect_from:
- /verify/test/src/tree/link_cut_tree/dynamic_tree_vertex_add_path_sum.test.cpp
- /verify/test/src/tree/link_cut_tree/dynamic_tree_vertex_add_path_sum.test.cpp.html
