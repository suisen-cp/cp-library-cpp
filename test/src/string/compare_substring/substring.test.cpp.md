...
data:
  ...
  attributes:
    ...
    PROBLEM: https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2444
    links:
    - https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2444
  bundledCode: "#line 1 \"test/src/string/compare_substring/substring.test.cpp\"\n\
    ...
    \ sa)) {}\n    };\n} // namespace suisen\n\n\n#line 6 \"test/src/string/compare_substring/substring.test.cpp\"\
    ...
    \ = cmp.substr(l, r);\n    }\n\n    std::sort(sub.begin(), sub.end());\n    sub.erase(std::unique(sub.begin(),\
    \ sub.end()), sub.end());\n\n    std::cout << sub.size() << std::endl;\n\n   \
    \ return 0;\n}\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=2444\"\
  ...
  verifiedWith: []
documentation_of: test/src/string/compare_substring/substring.test.cpp
layout: document
redirect_from:
- /verify/test/src/string/compare_substring/substring.test.cpp
- /verify/test/src/string/compare_substring/substring.test.cpp.html
