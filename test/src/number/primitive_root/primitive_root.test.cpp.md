...
data:
  ...
  bundledCode: "#line 1 \"test/src/number/primitive_root/primitive_root.test.cpp\"\
    ...
    \    }\n} // namespace suisen\n\n\n#line 6 \"test/src/number/primitive_root/primitive_root.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/src/number/primitive_root/primitive_root.test.cpp
layout: document
redirect_from:
- /verify/test/src/number/primitive_root/primitive_root.test.cpp
- /verify/test/src/number/primitive_root/primitive_root.test.cpp.html
