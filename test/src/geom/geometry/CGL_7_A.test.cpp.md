...
data:
  ...
  bundledCode: "#line 1 \"test/src/geom/geometry/CGL_7_A.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_A\"\n\n#include\
    ...
    \ { return Point(p) / Point(real, 0); }\n    Point operator+(coordinate_t real,\
    \ const Point &p) { return Point(real, 0) + Point(p); }\n    Point operator-(coordinate_t\
    ...
    #line 8 \"test/src/geom/geometry/CGL_7_A.test.cpp\"\n\nusing namespace suisen::geometry;\n\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_A\"\
    ...
    \ r1, r2;\n    std::cin >> c1 >> r1 >> c2 >> r2;\n    std::cout << tangent_num(Circle(c1,\
    \ r1), Circle(c2, r2)) << '\\n';\n    return 0;\n}"
  dependsOn:
  - library/geom/geometry.hpp
  ...
  verifiedWith: []
documentation_of: test/src/geom/geometry/CGL_7_A.test.cpp
layout: document
redirect_from:
- /verify/test/src/geom/geometry/CGL_7_A.test.cpp
- /verify/test/src/geom/geometry/CGL_7_A.test.cpp.html
