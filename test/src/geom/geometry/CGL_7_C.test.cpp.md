...
data:
  ...
  bundledCode: "#line 1 \"test/src/geom/geometry/CGL_7_C.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_C\"\n#define\
    \ ERROR 0.000001\n\n#include <cassert>\n#include <iostream>\n#include <iomanip>\n\
    ...
    \ a12 = d * h;\n        return a1 + a2 - a12;\n    }\n}\n} // namespace suisen\n\
    \n\n#line 9 \"test/src/geom/geometry/CGL_7_C.test.cpp\"\n\nusing namespace suisen::geometry;\n\
    \nint main() {\n    std::ios::sync_with_stdio(false);\n    std::cin.tie(nullptr);\n\
    \    std::cout << std::fixed << std::setprecision(20);\n\n    Point p1, p2, p3;\n\
    \    std::cin >> p1 >> p2 >> p3;\n    Circle c = pO(p1, p2, p3);\n    std::cout\
    \ << c.center << ' ' << c.radius << '\\n';\n    return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/src/geom/geometry/CGL_7_C.test.cpp
layout: document
redirect_from:
- /verify/test/src/geom/geometry/CGL_7_C.test.cpp
- /verify/test/src/geom/geometry/CGL_7_C.test.cpp.html
