...
data:
  ...
  bundledCode: "#line 1 \"test/src/geom/geometry/CGL_7_E.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_E\"\n#define\
    \ ERROR 0.000001\n\n#include <cassert>\n#include <iostream>\n#include <iomanip>\n\
    ...
    #line 9 \"test/src/geom/geometry/CGL_7_E.test.cpp\"\n\nusing namespace suisen::geometry;\n\
  ...
  verifiedWith: []
documentation_of: test/src/geom/geometry/CGL_7_E.test.cpp
layout: document
redirect_from:
- /verify/test/src/geom/geometry/CGL_7_E.test.cpp
- /verify/test/src/geom/geometry/CGL_7_E.test.cpp.html
