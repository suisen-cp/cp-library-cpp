...
data:
  ...
  bundledCode: "#line 1 \"test/src/geom/geometry/CGL_1_A.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_1_A\"\n#define\
    ...
    #line 8 \"test/src/geom/geometry/CGL_1_A.test.cpp\"\n\nusing namespace suisen::geometry;\n\
    \nint main() {\n    std::ios::sync_with_stdio(false);\n    std::cin.tie(nullptr);\n\
    \    std::cout << std::fixed << std::setprecision(20);\n\n    Point p1, p2;\n\
    \    std::cin >> p1 >> p2;\n    Line l(p1, p2);\n\n    int q;\n    std::cin >>\
    \ q;\n    while (q --> 0) {\n        Point p;\n        std::cin >> p;\n      \
    \  std::cout << projection(p, l) << '\\n';\n    }\n    return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/src/geom/geometry/CGL_1_A.test.cpp
layout: document
redirect_from:
- /verify/test/src/geom/geometry/CGL_1_A.test.cpp
- /verify/test/src/geom/geometry/CGL_1_A.test.cpp.html
