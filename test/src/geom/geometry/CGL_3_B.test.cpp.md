...
data:
  ...
  bundledCode: "#line 1 \"test/src/geom/geometry/CGL_3_B.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_3_B\"\n\n#include\
    ...
    #line 8 \"test/src/geom/geometry/CGL_3_B.test.cpp\"\n\nusing namespace suisen::geometry;\n\
  ...
  verifiedWith: []
documentation_of: test/src/geom/geometry/CGL_3_B.test.cpp
layout: document
redirect_from:
- /verify/test/src/geom/geometry/CGL_3_B.test.cpp
- /verify/test/src/geom/geometry/CGL_3_B.test.cpp.html
