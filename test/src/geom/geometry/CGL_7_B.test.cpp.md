...
data:
  ...
  bundledCode: "#line 1 \"test/src/geom/geometry/CGL_7_B.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_7_B\"\n#define\
    \ ERROR 0.000001\n\n#include <cassert>\n#include <iostream>\n#include <iomanip>\n\
    ...
    \ a12 = d * h;\n        return a1 + a2 - a12;\n    }\n}\n} // namespace suisen\n\
    \n\n#line 9 \"test/src/geom/geometry/CGL_7_B.test.cpp\"\n\nusing namespace suisen::geometry;\n\
  ...
  verifiedWith: []
documentation_of: test/src/geom/geometry/CGL_7_B.test.cpp
layout: document
redirect_from:
- /verify/test/src/geom/geometry/CGL_7_B.test.cpp
- /verify/test/src/geom/geometry/CGL_7_B.test.cpp.html
