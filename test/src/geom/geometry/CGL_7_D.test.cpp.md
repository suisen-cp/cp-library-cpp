...
data:
  ...
  bundledCode: "#line 1 \"test/src/geom/geometry/CGL_7_D.test.cpp\"\n#define PROBLEM\
    ...
    \ a12 = d * h;\n        return a1 + a2 - a12;\n    }\n}\n} // namespace suisen\n\
    \n\n#line 9 \"test/src/geom/geometry/CGL_7_D.test.cpp\"\n\nusing namespace suisen::geometry;\n\
    \nint main() {\n    std::ios::sync_with_stdio(false);\n    std::cin.tie(nullptr);\n\
    \    std::cout << std::fixed << std::setprecision(20);\n\n    Point center;\n\
    \    coordinate_t radius;\n    std::cin >> center >> radius;\n    Circle circle(center,\
    \ radius);\n\n    int q;\n    std::cin >> q;\n    while (q --> 0) {\n        Point\
    \ a, b;\n        std::cin >> a >> b;\n        auto v = common_point(circle, Line(a,\
...
layout: document
redirect_from:
- /verify/test/src/geom/geometry/CGL_7_D.test.cpp
- /verify/test/src/geom/geometry/CGL_7_D.test.cpp.html
