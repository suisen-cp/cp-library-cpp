...
data:
  ...
  bundledCode: "#line 1 \"test/src/math/set_power_series/arc105_f.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/arc105/tasks/arc105_f\"\n\n#include <iostream>\n\
    ...
    \            }\n        private:\n            int _d;\n        };\n\n        ZetaSPS\
    \ zeta() const {\n            return ZetaSPS(*this);\n        }\n    };\n} //\
    \ namespace suisen\n\n\n#line 10 \"test/src/math/set_power_series/arc105_f.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/src/math/set_power_series/arc105_f.test.cpp
layout: document
redirect_from:
- /verify/test/src/math/set_power_series/arc105_f.test.cpp
- /verify/test/src/math/set_power_series/arc105_f.test.cpp.html
