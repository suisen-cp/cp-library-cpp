...
data:
  ...
  bundledCode: "#line 1 \"test/src/math/lagrange_interpolation/cumulative_sum.test.cpp\"\
    \n#define PROBLEM \"https://atcoder.jp/contests/abc208/tasks/abc208_f\"\n\n#include\
    \ <iostream>\n#include <atcoder/modint>\n\n#line 1 \"library/math/lagrange_interpolation.hpp\"\
    ...
    \ f[mpf[i]] * f[i / mpf[i]];\n        }\n    }\n    for (int loop = 0; loop <\
    \ m; ++loop) {\n        for (int i = 1; i <= k + m; ++i) {\n            f[i] +=\
    \ f[i - 1];\n        }\n    }\n    std::cout << suisen::lagrange_interpolation(f,\
    \ mint(n)).val() << '\\n';\n    return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/src/math/lagrange_interpolation/cumulative_sum.test.cpp
layout: document
redirect_from:
- /verify/test/src/math/lagrange_interpolation/cumulative_sum.test.cpp
- /verify/test/src/math/lagrange_interpolation/cumulative_sum.test.cpp.html
