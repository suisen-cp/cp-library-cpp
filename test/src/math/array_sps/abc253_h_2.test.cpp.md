...
data:
  ...
  bundledCode: "#line 1 \"test/src/math/array_sps/abc253_h_2.test.cpp\"\n#define PROBLEM\
    \ \"https://atcoder.jp/contests/abc253/tasks/abc253_Ex\"\n\n#include <iostream>\n\
    ...
    \ N>(rf);\n            }\n        private:\n            int _d;\n        };\n\n\
    \        ZetaSPS zeta() const {\n            return ZetaSPS(*this);\n        }\n\
    \    };\n} // namespace suisen\n\n\n#line 10 \"test/src/math/array_sps/abc253_h_2.test.cpp\"\
    \n\nint main() {\n    int n, m;\n    std::cin >> n >> m;\n \n    std::vector g(n,\
    \ std::vector<int>(n, 0));\n\n    for (int i = 0; i < m; ++i) {\n        int u,\
    \ v;\n        std::cin >> u >> v;\n        --u, --v;\n        ++g[u][v], ++g[v][u];\n\
  ...
  verifiedWith: []
documentation_of: test/src/math/array_sps/abc253_h_2.test.cpp
layout: document
redirect_from:
- /verify/test/src/math/array_sps/abc253_h_2.test.cpp
- /verify/test/src/math/array_sps/abc253_h_2.test.cpp.html
