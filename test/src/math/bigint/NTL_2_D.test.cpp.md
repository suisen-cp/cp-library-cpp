...
data:
  ...
  attributes:
    ...
    PROBLEM: https://onlinejudge.u-aizu.ac.jp/courses/library/6/NTL/all/NTL_2_D
    links:
    - https://onlinejudge.u-aizu.ac.jp/courses/library/6/NTL/all/NTL_2_D
  bundledCode: "#line 1 \"test/src/math/bigint/NTL_2_D.test.cpp\"\n#define PROBLEM\
    \ \"https://onlinejudge.u-aizu.ac.jp/courses/library/6/NTL/all/NTL_2_D\"\n\n#include\
    ...
    \ = false;\n        }\n    };\n} // namespace suisen\n\n\n\n#line 6 \"test/src/math/bigint/NTL_2_D.test.cpp\"\
    \nusing suisen::bigint;\n\nint main() {\n    std::ios::sync_with_stdio(false);\n\
    \    std::cin.tie(nullptr);\n\n    bigint a, b;\n    std::cin >> a >> b;\n   \
    \ std::cout << a / b << std::endl;\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://onlinejudge.u-aizu.ac.jp/courses/library/6/NTL/all/NTL_2_D\"\
  ...
  verifiedWith: []
documentation_of: test/src/math/bigint/NTL_2_D.test.cpp
layout: document
redirect_from:
- /verify/test/src/math/bigint/NTL_2_D.test.cpp
- /verify/test/src/math/bigint/NTL_2_D.test.cpp.html
