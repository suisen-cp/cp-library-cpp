...
data:
  ...
  attributes:
    ...
    PROBLEM: https://atcoder.jp/contests/abc213/tasns/abc213_g
    links:
    - https://atcoder.jp/contests/abc213/tasns/abc213_g
  bundledCode: "#line 1 \"test/src/math/sps/connectivity2.test.cpp\"\n#define PROBLEM\
    ...
    \ suisen\n\n\n#line 9 \"test/src/math/sps/connectivity2.test.cpp\"\n\nusing namespace\
    \ suisen;\n\nint main() {\n    int n, m;\n    std::cin >> n >> m;\n    std::vector<int>\
    \ c(1 << n, 0);\n    for (int i = 0; i < m; ++i) {\n        int u, v;\n      \
    ...
    \ f[i] * g[full ^ i];\n        for (int j = 0; j < n; ++j) ans[j] += ((i >> j)\
    \ & 1) * x;\n    }\n    for (int i = 1; i < n; ++i) {\n        std::cout << ans[i].val()\
    \ << std::endl;\n    }\n    return 0;\n}\n"
  code: "#define PROBLEM \"https://atcoder.jp/contests/abc213/tasns/abc213_g\"\n\n\
    #include <iostream>\n#include <atcoder/modint>\n\nusing mint = atcoder::modint998244353;\n\
