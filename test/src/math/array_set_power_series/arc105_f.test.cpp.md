...
data:
  ...
  bundledCode: "#line 1 \"test/src/math/array_set_power_series/arc105_f.test.cpp\"\
    ...
    \ N>(rf);\n            }\n        private:\n            int _d;\n        };\n\n\
    \        ZetaSPS zeta() const {\n            return ZetaSPS(*this);\n        }\n\
    \    };\n} // namespace suisen\n\n\n#line 9 \"test/src/math/array_set_power_series/arc105_f.test.cpp\"\
    ...
    \ - 1] * 2;\n    }\n    ArraySetPowerSeries<mint, 18> p(n);\n    for (int i =\
    \ 0; i < 1 << n; ++i) {\n        p[i] = pow_inv_2[c[i]];\n    }\n    ArraySetPowerSeries<mint,\
    \ 18> q = p.pow(2);\n    for (int i = 0; i < 1 << n; ++i) {\n        q[i] *= pow_2[c[i]];\n\
...
layout: document
redirect_from:
- /verify/test/src/math/array_set_power_series/arc105_f.test.cpp
- /verify/test/src/math/array_set_power_series/arc105_f.test.cpp.html
