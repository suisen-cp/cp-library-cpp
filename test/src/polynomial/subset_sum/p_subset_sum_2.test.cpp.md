...
data:
  ...
  bundledCode: "#line 1 \"test/src/polynomial/subset_sum/p_subset_sum_2.test.cpp\"\
    ...
    \ e : log) e *= p;\n        return log;\n    }\n} // namespace suisen\n\n\n#line\
    \ 8 \"test/src/polynomial/subset_sum/p_subset_sum_2.test.cpp\"\n\nusing mint =\
  ...
  code: "#define PROBLEM \"https://judge.yosupo.jp/problem/sharp_p_subset_sum\"\n\n\
    ...
    \nint main() {\n    int n, t;\n    std::cin >> n >> t;\n    std::vector<int> items(n);\n\
    \    for (int &e : items) std::cin >> e;\n    auto f = suisen::subset_sum<suisen::FormalPowerSeries<mint>>(t,\
    \ items);\n    for (int i = 1; i <= t; ++i) {\n        std::cout << f[i].val()\
    \ << \" \\n\"[i == t];\n    }\n    return 0;\n}"
  dependsOn:
...
layout: document
redirect_from:
- /verify/test/src/polynomial/subset_sum/p_subset_sum_2.test.cpp
- /verify/test/src/polynomial/subset_sum/p_subset_sum_2.test.cpp.html
