...
data:
  ...
  bundledCode: "#line 1 \"test/src/polynomial/rook_polynomial/dummy.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_1_A\"\
  ...
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=ITP1_1_A\"\
    ...
    \    pd[0] = { 1 };\n    for (int k : h) {\n        std::map<int, fps> dp;\n \
    \       for (auto [mask, f] : pd) {\n            const int nxt_mask = mask ^ ((mask\
    \ >> k) << k);\n            dp[nxt_mask] += f;\n            for (int pos = 0;\
    \ pos < k; ++pos) if (not ((nxt_mask >> pos) & 1)) {\n                dp[nxt_mask\
    \ | (1 << pos)] += f << 1;\n            }\n        }\n        pd.swap(dp);\n \
    \   }\n    fps res(h.size() + 1);\n    for (auto [_, f] : pd) res += f;\n    return\
  ...
  verifiedWith: []
documentation_of: test/src/polynomial/rook_polynomial/dummy.test.cpp
layout: document
redirect_from:
- /verify/test/src/polynomial/rook_polynomial/dummy.test.cpp
- /verify/test/src/polynomial/rook_polynomial/dummy.test.cpp.html
