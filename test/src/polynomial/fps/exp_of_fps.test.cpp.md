...
data:
  ...
  bundledCode: "#line 1 \"test/src/polynomial/fps/exp_of_fps.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/exp_of_formal_power_series\"\n\n#include <iostream>\n\
    ...
    \ a, T b) {\n    return a.pow(b);\n}\ntemplate <typename mint>\nsuisen::FPS<mint>\
    \ inv(suisen::FPS<mint> a) {\n    return a.inv();\n}\n\n\n#line 10 \"test/src/polynomial/fps/exp_of_fps.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/src/polynomial/fps/exp_of_fps.test.cpp
layout: document
redirect_from:
- /verify/test/src/polynomial/fps/exp_of_fps.test.cpp
- /verify/test/src/polynomial/fps/exp_of_fps.test.cpp.html
