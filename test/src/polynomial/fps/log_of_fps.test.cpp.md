...
data:
  ...
  bundledCode: "#line 1 \"test/src/polynomial/fps/log_of_fps.test.cpp\"\n#define PROBLEM\
    \ \"https://judge.yosupo.jp/problem/log_of_formal_power_series\"\n\n#include <iostream>\n\
    ...
    \ a) -> decltype(mint::mod(), suisen::FPS<mint>{}) {\n    return a.inv(a.deg());\n\
    }\n\n\n#line 10 \"test/src/polynomial/fps/log_of_fps.test.cpp\"\n\nusing mint\
  ...
  verifiedWith: []
documentation_of: test/src/polynomial/fps/log_of_fps.test.cpp
layout: document
redirect_from:
- /verify/test/src/polynomial/fps/log_of_fps.test.cpp
- /verify/test/src/polynomial/fps/log_of_fps.test.cpp.html
