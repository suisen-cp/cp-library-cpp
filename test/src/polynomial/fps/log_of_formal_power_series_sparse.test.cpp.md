...
data:
  ...
  bundledCode: "#line 1 \"test/src/polynomial/fps/log_of_formal_power_series_sparse.test.cpp\"\
    ...
    \ a, T b) {\n    return a.pow(b);\n}\ntemplate <typename mint>\nsuisen::FPS<mint>\
    \ inv(suisen::FPS<mint> a) {\n    return a.inv();\n}\n\n\n#line 9 \"test/src/polynomial/fps/log_of_formal_power_series_sparse.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/src/polynomial/fps/log_of_formal_power_series_sparse.test.cpp
layout: document
redirect_from:
- /verify/test/src/polynomial/fps/log_of_formal_power_series_sparse.test.cpp
- /verify/test/src/polynomial/fps/log_of_formal_power_series_sparse.test.cpp.html
