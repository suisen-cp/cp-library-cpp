...
data:
  ...
  bundledCode: "#line 1 \"test/src/polynomial/fps/inv_of_formal_power_series_sparse.test.cpp\"\
    ...
    \ suisen::FPS<mint>{}) {\n    return a.inv(a.deg());\n}\n\n\n#line 9 \"test/src/polynomial/fps/inv_of_formal_power_series_sparse.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/src/polynomial/fps/inv_of_formal_power_series_sparse.test.cpp
layout: document
redirect_from:
- /verify/test/src/polynomial/fps/inv_of_formal_power_series_sparse.test.cpp
- /verify/test/src/polynomial/fps/inv_of_formal_power_series_sparse.test.cpp.html
