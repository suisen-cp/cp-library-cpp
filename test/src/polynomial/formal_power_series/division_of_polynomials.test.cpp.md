...
data:
  ...
  bundledCode: "#line 1 \"test/src/polynomial/formal_power_series/division_of_polynomials.test.cpp\"\
    ...
    \ a) {\n    return a.inv();\n}\n\n\n#line 10 \"test/src/polynomial/formal_power_series/division_of_polynomials.test.cpp\"\
  ...
  verifiedWith: []
documentation_of: test/src/polynomial/formal_power_series/division_of_polynomials.test.cpp
layout: document
redirect_from:
- /verify/test/src/polynomial/formal_power_series/division_of_polynomials.test.cpp
- /verify/test/src/polynomial/formal_power_series/division_of_polynomials.test.cpp.html
