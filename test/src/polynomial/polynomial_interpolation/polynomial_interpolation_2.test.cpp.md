...
data:
  ...
  bundledCode: "#line 1 \"test/src/polynomial/polynomial_interpolation/polynomial_interpolation_2.test.cpp\"\
    ...
    \n\n\n\n#line 6 \"library/polynomial/polynomial_interpolation.hpp\"\n\nnamespace\
    \ suisen {\n    template <typename FPSType, typename T>\n    FPSType polynomial_interpolation(const\
    ...
    \    }\n\n} // namespace suisen\n\n\n\n#line 9 \"test/src/polynomial/polynomial_interpolation/polynomial_interpolation_2.test.cpp\"\
    \n\nusing mint = atcoder::modint998244353;\n\nint main() {\n    int n;\n    std::cin\
    \ >> n;\n    std::vector<mint> x(n), y(n);\n    for (int i = 0; i < n; ++i) {\n\
    \        int xi;\n        std::cin >> xi;\n        x[i] = xi;\n    }\n    for\
    \ (int i = 0; i < n; ++i) {\n        int yi;\n        std::cin >> yi;\n      \
    \  y[i] = yi;\n    }\n    auto f = suisen::polynomial_interpolation<suisen::FormalPowerSeries<mint>>(x,\
    \ y);\n    for (int i = 0; i < n; ++i) {\n        std::cout << f[i].val() << \"\
    \ \\n\"[i == n - 1];\n    }\n    return 0;\n}\n"
  ...
  verifiedWith: []
documentation_of: test/src/polynomial/polynomial_interpolation/polynomial_interpolation_2.test.cpp
layout: document
redirect_from:
- /verify/test/src/polynomial/polynomial_interpolation/polynomial_interpolation_2.test.cpp
- /verify/test/src/polynomial/polynomial_interpolation/polynomial_interpolation_2.test.cpp.html
