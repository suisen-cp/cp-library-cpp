...
data:
  ...
  attributes:
    ...
    PROBLEM: https://yukicoder.me/problems/no/2097
    links:
    - https://yukicoder.me/problems/no/2097
  bundledCode: "#line 1 \"test/src/polynomial/prod_f(r^k_x)/yuki2097.test.cpp\"\n\
    ...
    \ r, m, result_size - z * m);\n        f *= d, f <<= z * m;\n        return f;\n\
    \    }\n} // namespace suisen\n\n\n#line 10 \"test/src/polynomial/prod_f(r^k_x)/yuki2097.test.cpp\"\
    \n\nusing mint = atcoder::modint998244353;\n\nint main() {\n    std::ios::sync_with_stdio(false);\n\
    \    std::cin.tie(nullptr);\n\n    int n, m, l;\n    std::cin >> n >> m >> l;\n\
    \n    suisen::factorial<mint> fac(l);\n\n    suisen::FormalPowerSeries<mint> f(l\
    \ + 1);\n    f[0] = mint(2).pow(n);\n    for (int i = 1; i <= l; ++i) {\n    \
    \    f[i] = fac.fac_inv(i);\n    }\n\n    f = prod_f_rk_x(f, 2, m);\n\n    for\
  ...
  verifiedWith: []
documentation_of: test/src/polynomial/prod_f(r^k_x)/yuki2097.test.cpp
layout: document
redirect_from:
- /verify/test/src/polynomial/prod_f(r^k_x)/yuki2097.test.cpp
- /verify/test/src/polynomial/prod_f(r^k_x)/yuki2097.test.cpp.html
