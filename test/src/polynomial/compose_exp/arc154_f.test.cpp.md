...
data:
  ...
  bundledCode: "#line 1 \"test/src/polynomial/compose_exp/arc154_f.test.cpp\"\n#define\
    \ PROBLEM \"https://atcoder.jp/contests/arc154/tasks/arc154_f\"\n\n#include <iostream>\n\
    ...
    \ a) {\n    return a.inv();\n}\n\n\n#line 1 \"library/polynomial/rational_fps.hpp\"\
    ...
    \ suisen\n\n\n#line 1 \"library/polynomial/compose_exp.hpp\"\n\n\n\n#line 7 \"\
    library/polynomial/compose_exp.hpp\"\n\nnamespace suisen {\n    // Calculates\
    \ f(e^x) mod x^n in O(d (log d)^2 + n log n), where d := deg f.\n    template\
    \ <typename FPSType>\n    FPSType compose_exp(const FPSType& f, int n) {\n   \
    \     // f(x) = Sum_i A_i x^i\n        // f(e^x) := Sum_i B_i x^i, F(x) := Sum_i\
    \ B_i i! x^i\n        // F(x) = Sum_i A_i Sum_j (ix)^j\n        //      = Sum_i\
    \ A_i/(1-ix)\n        using mint = typename FPSType::value_type;\n        using\
    \ RFPS = RationalFPS<FPSType>;\n        std::vector<RFPS> fs;\n        for (int\
    \ i = 0; i < f.size(); ++i) {\n            fs.emplace_back(FPSType{ f[i] }, FPSType{\
    \ 1, -i });\n        }\n        FPSType g = RFPS::sum(fs).to_fps(n);\n       \
    \ factorial<mint> fac(n);\n        for (int i = 2; i < n; ++i) {\n           \
    \ g[i] *= fac.fac_inv(i);\n        }\n        return g;\n    }\n} // namespace\
    \ suisen\n\n\n\n#line 14 \"test/src/polynomial/compose_exp/arc154_f.test.cpp\"\
    \n\nusing fps = suisen::FormalPowerSeries<mint>;\nusing rational_fps = suisen::RationalFPS<fps>;\n\
    \nint main() {\n    std::ios::sync_with_stdio(false);\n    std::cin.tie(nullptr);\n\
    \    \n    int n, m;\n    std::cin >> n >> m;\n    \n    std::vector<fps> dens(n);\n\
    \    for (int i = 0; i < n; ++i) {\n        dens[i] = { n, -(n - (i + 1)) };\n\
    \    }\n \n    suisen::factorial<mint> fac(m);\n    suisen::pow_mods<mint> pow_n(n,\
    \ m);\n \n    fps f(m + 1);\n    for (int i = 0; i <= m; ++i) {\n        f[i]\
    \ = fac.fac(n) * fac.fac_inv(i) * pow_n[i];\n    }\n    fps g = suisen::compose_exp(fps::prod(dens),\
...
layout: document
redirect_from:
- /verify/test/src/polynomial/compose_exp/arc154_f.test.cpp
- /verify/test/src/polynomial/compose_exp/arc154_f.test.cpp.html
