...
data:
  ...
  bundledCode: "#line 1 \"test/src/datastructure/bbst/reversible_implicit_treap_segtree/range_reverse_range_sum.test.cpp\"\
    ...
    \    for (auto &e : a) std::cin >> e;\n\n    suisen::ReversibleDynamicSegmentTree<long\
    \ long, op, e, toggle> seg(a);\n    for (int query_id = 0; query_id < q; ++query_id)\
    \ {\n        int t, l, r;\n        std::cin >> t >> l >> r;\n        if (t ==\
    \ 0) {\n            seg.reverse(l, r);\n        } else {\n            std::cout\
    \ << seg.prod(l, r) << '\\n';\n        }\n    }\n    return 0;\n}\n"
  ...
  requiredBy: []
  timestamp: '2023-05-11 13:36:27+09:00'
  verificationStatus: TEST_ACCEPTED
  verifiedWith: []
documentation_of: test/src/datastructure/bbst/reversible_implicit_treap_segtree/range_reverse_range_sum.test.cpp
layout: document
redirect_from:
- /verify/test/src/datastructure/bbst/reversible_implicit_treap_segtree/range_reverse_range_sum.test.cpp
- /verify/test/src/datastructure/bbst/reversible_implicit_treap_segtree/range_reverse_range_sum.test.cpp.html
