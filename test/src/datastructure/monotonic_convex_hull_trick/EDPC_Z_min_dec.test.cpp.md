...
data:
  ...
  bundledCode: "#line 1 \"test/src/datastructure/monotonic_convex_hull_trick/EDPC_Z_min_dec.test.cpp\"\
    ...
    \ suisen\n\n\n#line 6 \"test/src/datastructure/monotonic_convex_hull_trick/EDPC_Z_min_dec.test.cpp\"\
    \n\nusing suisen::MinMonotonicCHT;\nusing suisen::dec_query_tag;\n\nint main()\
    \ {\n    std::ios::sync_with_stdio(false);\n    std::cin.tie(nullptr);\n    int\
    \ n;\n    long long c;\n    std::cin >> n >> c;\n    std::vector<long long> h(n);\n\
    \    for (int i = 0; i < n; ++i) {\n        std::cin >> h[i];\n    }\n    std::vector<long\
    \ long> dp(n, 0);\n    MinMonotonicCHT<long long, dec_query_tag> cht;\n    for\
    \ (int i = 1; i < n; ++i) {\n        cht.add_line(2 * h[i - 1], dp[i - 1] + h[i\
  ...
  verifiedWith: []
documentation_of: test/src/datastructure/monotonic_convex_hull_trick/EDPC_Z_min_dec.test.cpp
layout: document
redirect_from:
- /verify/test/src/datastructure/monotonic_convex_hull_trick/EDPC_Z_min_dec.test.cpp
- /verify/test/src/datastructure/monotonic_convex_hull_trick/EDPC_Z_min_dec.test.cpp.html
