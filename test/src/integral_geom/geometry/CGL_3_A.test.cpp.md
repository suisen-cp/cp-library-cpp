...
data:
  ...
  bundledCode: "#line 1 \"test/src/integral_geom/geometry/CGL_3_A.test.cpp\"\n#define\
    \ PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_3_A\"\
    \n\n#include <cassert>\n#include <iostream>\n#include <iomanip>\n\n#line 1 \"\
    ...
    \    }\n} // namespace suisen::integral_geometry\n\n\n#line 8 \"test/src/integral_geom/geometry/CGL_3_A.test.cpp\"\
    \n\nusing namespace suisen::integral_geometry;\n\nint main() {\n    std::ios::sync_with_stdio(false);\n\
    \    std::cin.tie(nullptr);\n    std::cout << std::fixed << std::setprecision(1);\n\
    \n    int n;\n    std::cin >> n;\n\n    Polygon poly(n);\n    for (int i = 0;\
    \ i < n; ++i) {\n        std::cin >> poly[i];\n    }\n    std::cout << std::fixed\
    \ << std::setprecision(1) << area_doubled(poly) / 2. << '\\n';\n    return 0;\n\
    }\n"
  code: "#define PROBLEM \"https://judge.u-aizu.ac.jp/onlinejudge/description.jsp?id=CGL_3_A\"\
    ...
    \    std::cout << std::fixed << std::setprecision(1);\n\n    int n;\n    std::cin\
    \ >> n;\n\n    Polygon poly(n);\n    for (int i = 0; i < n; ++i) {\n        std::cin\
    \ >> poly[i];\n    }\n    std::cout << std::fixed << std::setprecision(1) << area_doubled(poly)\
    \ / 2. << '\\n';\n    return 0;\n}"
  dependsOn:
  - library/integral_geom/geometry.hpp
  - library/integral_geom/point.hpp
...
layout: document
redirect_from:
- /verify/test/src/integral_geom/geometry/CGL_3_A.test.cpp
- /verify/test/src/integral_geom/geometry/CGL_3_A.test.cpp.html
