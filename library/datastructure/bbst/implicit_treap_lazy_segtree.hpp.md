...
data:
  ...
  attributes:
    links: []
  bundledCode: "#line 1 \"library/datastructure/bbst/implicit_treap_lazy_segtree.hpp\"\
    ...
    \ k);\n        }\n    };\n} // namespace suisen\n\n\n\n"
  code: "#ifndef SUISEN_IMPLICIT_TREAP_LAZY_SEGTREE\n#define SUISEN_IMPLICIT_TREAP_LAZY_SEGTREE\n\
    \n#include \"library/datastructure/bbst/implicit_treap_base.hpp\"\n\nnamespace\
    \ suisen {\n    namespace internal::implicit_treap {\n        template <typename\
    \ T, T(*op)(T, T), T(*e)(), T(*toggle)(T), typename F, T(*mapping)(F, T), F(*composition)(F,\
    \ F), F(*id)()>\n        struct RangeOperateRangeProductNode: Node<T, RangeOperateRangeProductNode<T,\
    \ op, e, toggle, F, mapping, composition, id>> {\n            using base = Node<T,\
    \ RangeOperateRangeProductNode<T, op, e, toggle, F, mapping, composition, id>>;\n\
