...
data:
  ...
  bundledCode: "#line 1 \"library/datastructure/segment_tree/persistent_segment_tree.hpp\"\
    ...
    \ node, int siz, int i) {\n                value_type res;\n                search_node</*\
    \ do_update = */false>(node, siz, i, [&](node_pointer_type i_th_node) { res =\
    \ i_th_node->_dat; });\n                return res;\n            }\n         \
    \   template <typename F>\n            static node_pointer_type apply(node_pointer_type\
    \ node, int siz, int i, F&& f) {\n                return search_node</* do_update\
    \ = */true>(node, siz, i, [&](node_pointer_type i_th_node) { i_th_node->_dat =\
    \ f(i_th_node->_dat); });\n            }\n            static node_pointer_type\
  ...
  requiredBy: []
  timestamp: '2022-03-16 21:07:02+09:00'
