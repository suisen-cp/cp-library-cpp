...
data:
  ...
  bundledCode: "#line 1 \"library/datastructure/lazy_eval_map.hpp\"\n\n\n\n#include\
    ...
    \ Val, Val(*op)(Val, Val), Val (*e)(), typename F, Val(*mapping)(F, Val), F(*composition)(F,\
...
layout: document
redirect_from:
- /library/library/datastructure/lazy_eval_map.hpp
- /library/library/datastructure/lazy_eval_map.hpp.html
