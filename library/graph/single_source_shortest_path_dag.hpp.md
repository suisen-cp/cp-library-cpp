...
data:
  ...
  bundledCode: "#line 1 \"library/graph/single_source_shortest_path_dag.hpp\"\n\n\n\
    ...
    } // namespace suisen\n\n\n#line 9 \"library/graph/single_source_shortest_path_dag.hpp\"\
    \n\nnamespace suisen {\n    template <typename T>\n    std::vector<typename Graph<T>::weight_type_or_1>\
    \ single_source_shortest_path_dag(const Graph<T>& g, const int s) {\n        using\
    \ cost_type = typename Graph<T>::weight_type_or_1;\n        constexpr cost_type\
    \ inf = std::numeric_limits<cost_type>::max();\n        const int n = g.size();\n\
    ...
    \            int u = dq.front();\n            dq.pop_front();\n            for\
    \ (const auto &e : g[u]) {\n                const int v = e;\n               \
    \ if (res[u] != inf) {\n                    res[v] = std::min(res[v], res[u] +\
    \ g.get_weight(e));\n                }\n                if (--in[v] == 0) {\n\
    \                    dq.push_back(v);\n                }\n            }\n    \
    \    }\n        return res;\n    }\n} // namespace suisen\n\n\n\n"
  code: "#ifndef SUISEN_SINGLE_SOURCE_SHORTEST_PATH_DAG\n#define SUISEN_SINGLE_SOURCE_SHORTEST_PATH_DAG\n\
