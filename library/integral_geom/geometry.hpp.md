...
data:
  ...
  bundledCode: "#line 1 \"library/integral_geom/geometry.hpp\"\n\n\n\n#include <algorithm>\n\
    ...
    \ long x, y;\n        constexpr Point(long long x = 0, long long y = 0) : x(x),\
    \ y(y) {}\n\n        operator std::pair<coordinate_t, coordinate_t>() { return\
...
layout: document
redirect_from:
- /library/library/integral_geom/geometry.hpp
- /library/library/integral_geom/geometry.hpp.html
